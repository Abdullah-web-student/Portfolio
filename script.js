...
// const skills = [
//     { name: 'OFFICE', icon: 'fa-solid fa-file-word' },  // Example icon for Office
...
// let con2 = document.getElementById("con2_row1");

// skills.forEach(skill => {
//     let skillDiv = document.createElement('div');
//     skillDiv.classList.add('sbox');

//     // Create icon element
//     let icon = document.createElement('i');
//     icon.className = skill.icon; // Set Font Awesome class
//     icon.style.fontSize = "2rem"; // Adjust icon size
//     icon.style.marginBottom = "8px"; // Add spacing

//     // Create text element
//     let text = document.createElement('p');
//     text.textContent = skill.name;

//     // Append icon and text to skill box
//     skillDiv.appendChild(icon);
//     skillDiv.appendChild(text);

//     // Append skill box to container
//     con2.appendChild(skillDiv);
// });
...
//     { name: 'SQL (SSMS)', icon: 'fa-solid fa-database' }  
// ];

// let row_2 = document.getElementById("con2_row2");
